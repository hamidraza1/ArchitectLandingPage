          ...
          <div className="flex justify-between w-full  xl:mt-10 lg:mt-6 md:mt-4 lg:px-4 sm:mt-2  mt-1 ">
            <div className="flex flex-col h-40 xl:h-48 lg:h-48 md:h-32 xl:justify-between  lg:justify-between md:ml-2 sm:h-32 sm:ml-6 h-24 ml-6 ">
              <div className="text- flex items-center">
                ...
                <span className="xl:text-base lg:text-sm md:text-xs xl:mb-0 lg:mb-0 md:mb-4 md:font-light  sm:text-s sm:mb-4 sm:font-light   text-xs mb-3 font-light">
              ...
              <div className="text- flex items-center">
                ...
                <span className="xl:text-base lg:text-sm md:text-xs md:font-light   sm:text-s sm:mb-4 sm:font-light  text-xs mb-3 font-light ">
                  Form 7:05AM to 19:30PM
                </span>
              </div>
            </div>
            <div className="flex flex-col xl:h-48 lg:48 md:h-32 justify-between sm:w-12/25 w-2/6  md:mr-2 h-32 mr-4">
              <input
              ...
              <div className="flex flex-col sm:items-end  ">
                <button className="sm:w-1/2 w-full border border-myColors-darkBlack text-myColors-darkBlack xl:py-3 lg:py-1 md:py-0 md:text-sm">
                  SUBMIT
                </button>
              </div>
            </div>
